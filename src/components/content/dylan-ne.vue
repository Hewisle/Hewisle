<template>
  ...
  <p>
    ...
    bekend waren. Na het kiezen en lezen van het sprookje ging ik een storyboard
  ...
  <p>
    ...
    “Hans Mijn Egel”. Voor het sprookje had ik een Storyboard gemaakt waarin de
    scenes werden gekozen die ik ging animeren.
  </p>

  <figure>
    <q-img src="../../assets/content/dylan-storyboard.png" fit="contain" />
  </figure>

  <p>Hier zijn de scenes die ik had gemaakt:</p>

  <p>
    Scene 1: Een donkere avond zie je van buitenaf een kind geboren worden, de
    schaduw is van een vorm van een egel.
  </p>

  <figure>
    <q-img src="../../assets/content/dylan-scene1.png" fit="contain" />
    <q-chip square>Scene 1</q-chip>
  </figure>

  <p>
    Scene 2: Terwijl Hans en zijn naar de kermis lopen vraagt Hans of hij een
    doedelzak mag. Na het krijgen van een doedelzak vraagt hij een zadel voor
  ...
  <p>
    ...
    vraagt aan Hans voor eten en de weg terug naar zijn koninkrijk. Hans geeft
    de koning voedsel de koning. Daarna speelt Hans op zijn doedelzak en de
  ...
  <figure>
    <q-img src="../../assets/content/dylan-scene4.png" fit="contain" />
    <q-chip square>Achtergrond scene 4</q-chip>
  </figure>

  <figure>
    <q-img src="../../assets/content/dylan-haan.png" fit="contain" />
    <q-chip square>Karakter Haan waar hans op rijd</q-chip>
  </figure>

  <p>
    Scene 5: De koning loopt naar de poort met de gedachten dat hij als eerst
  ...
  <p>
    En hier is het eindresultaat waar ik alle scenes in één video had geplaatst:
  </p>

  <figure>
    <iframe     width="560"
    height="315"
    src="https://www.youtube.com/embed/8RPPfOco6NI" fit="contain"
  ...
  <p>
    ...
    van vuur. Dit betekent dat ik ging werken met alleen maar mijn eigen kennis.
    Al heb ik wel geleerd hoe lang je over een scéne doet, hoewel dat sneller
    ging tijdens het maken van de animatie.
  </p>

  <p>
    Daarnaast had ik geleerd dat karakters er meer interessanter uitzien als je
    verschillende soorten lijnen gebruikt en dat als objecten naar voren je meer
    diepgang kan krijgen zelfs bij 2d animatie. Dit hielp veel om de animatie
    een leuker en interessanter te maken. Ook was het een Storyboard heel
    leerzaam, hierdoor waren de scenes goed uitgestippeld en kon ik meteen zien
